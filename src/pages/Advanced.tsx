...
const Advanced = () => {
  ...
  const { defaultTiles, defaultLayout } = tiles([
    ...
    { el: <DroneImage />, id: "di", name: "Drohnenbild", main: { x: 0, y: 15, w: 8, h: 12 }, mobile: { x: 0, y: 29, w: 24, h: 12 } },
    { el: <AiImage />, id: "aii", name: "KI Einschätzung", main: { x: 8, y: 15, w: 8, h: 12 }, mobile: { x: 0, y: 29, w: 24, h: 12 } },
    { el: <AiAnalysis />, id: "aia", name: "KI Analyse", main: { x: 16, y: 15, w: 8, h: 12 }, mobile: { x: 0, y: 29, w: 24, h: 12 } },
